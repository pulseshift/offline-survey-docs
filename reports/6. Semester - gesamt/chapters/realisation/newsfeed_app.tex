...
\item {Cotap https://www.zinc.it/ Beliebteste/Am häufigsten genutzte App für „Deskless“ Mitarbeiter}
...
Microsoft StaffHub ist eine speziell für die Firstline Workforce in Office 365 entwickelte App. Sie wurde speziell entwickelt, um die Fähigkeiten, Werkzeuge und Informationen zu liefern, die Firstline Mitarbeiter benötigen, um effektiv zu arbeiten. Dieser Service kombiniert Terminplanung, Aufgabenverwaltung, Dokumente, Personen und Tools an einem sicheren Ort - mit der Möglichkeit, sich mit anderen arbeitsbezogenen Apps und Ressourcen zu verbinden.

StaffHub umfasst dabei folgende Grundfunktionalitäten:
\begin{itemize}
...
Außerdem können einzelne Aufgaben und To-Dos vergeben werden. Diese können direkt durch den Manager vergeben werden. Auch Mitarbeiter können sich selbst Erinnerungen für ihre anliegenden Aufgaben erstellen.
...
Für die Zukunft ist geplant mit Hilfe der App eine Zeiterfassung in Realtime zu ermöglichen, sodass nicht mehr klassisch gestempelt werden muss.
Zusätzlich ist es möglich die Funktionalitäten zu erweitern und weitere Services und Apps an Staffhub anzubinden.

\subsubsection{Communications \& Community}

In Staffhub können jederzeit neue Kommunikationskanäle aufgesetzt werden, wodurch es möglich ist Gruppen oder persönliche Chats zu starten. Des Weiteren können von dem Unternehmen Best Practices oder Neuigkeiten durch Announcements an den Mitarbeiter kommuniziert werden.
...
Mit Staffhub ist es möglich Dokumente und Dateien zu verwalten und innerhalb des Unternehmens zu teilen. Dies wird unter anderem durch die Integration von SharePoint und team sites unterstützt. Auf den Inhalt kann direkt innerhalb der App zugegriffen werden. Auch Trainings oder Onboarding Aktivitäten  können damit geplant werden.
...
In Staffhub können über die API 3rd Party Lösungen für Workforce Management eingebunden werden. Des Weiteren kann man benutzerspezifische Integrationen für interne Applikationen und Prozesse hinzufügen. Zusätzlich ist die Integration mit Kronos WorkForce Central V8 unterstützt und es werden Connector bereitgestellt, um mit Microsoft Flow zu arbeiten.
...
Microsoft Teams ist ein Chat-basierter Arbeitsbereich, der Personen, Unterhaltungen und Inhalte zusammenführt. Microsoft StaffHub ist hingegen eine speziell entwickelte App für die Firstline Workforce zur Verwaltung ihres Arbeitstages. Laut Microsoft ist die Kommunikation für beide wichtig und kündigten kürzlich die Integration von StaffHub Messaging und Microsoft Teams an, um es Firstline Workers zu ermöglichen, sich mit allen Mitarbeitern zu verbinden, um mit ihnen zusammenzuarbeiten.
...
Insgesamt erweist sich Microsoft StaffHub als sehr umfrangreiches und mächtiges Tool, obwohl es erst vor kurzem für die Öffentlichkeit verfügbar ist. Dadurch besteht die Möglichkeit, dass PulseShift sich die Funktionen von StaffHub zu Nutzen machen kann, um die Umfrage in das Tool einzubinden. Dafür gibt es mehrere Optionen: PulseShift kann ein eigenen User beantragen und ist neben allen Mitarbeitern innerhalb des nutzenden Unternehmens zusätzlich als Drittpartei eingebunden. Dies ermöglicht, dass PulseShift in einem Teamchat regelmäßig auf die Umfrage aufmerksam machen kann oder die Umfrage zentral an alle Mitarbeiter über ein Announcement verteilen kann, da es problemlos möglich ist einen Link oder ein Dokument innerhalb der App aufzurufen. Außerdem kann es jedem Nutzer individuell als To-Do Task assigned werden, wodurch der Mitarbeiter sich eher in der Verpflichtung sieht diese Aufgabe zu erledigen.
...
\subsection{Inkling}
Inkling ist eine mobile Plattform die die Mitarbeiter des Unternehmens an vorderster Front verbindet und ihnen dabei hilft, ihr volles Potenzial auszuschöpfen. Der Fokus liegt dabei auf dem Einzelhandel.
\newline
Mit Inkling Collaboration erzielt man eine bessere Ausführung, indem die Frontline mit den benötigten Mitarbeitern und Ressourcen verbunden werden. Store-Teams verbringen weniger Zeit im Backoffice und mehr Zeit auf der Verkaufsfläche. Das bedeutet engagierte Mitarbeiter, zufriedenere Kunden und schnelleres Umsatzwachstum. 
...
Die Daten und der momentane Prozess der Aufgaben aller Mitarbeiter kann jederzeit abgerufen und analysiert werden. Hierbei ist es möglich den aktuellen Vervollständigungsgrad, hochgeladene Fotos und wie viele Mitarbeiter die Aufgabe angesehen haben, einzusehen. 
...
Inkling wird von vielen bekannten Unternehmen wie McDonalds oder Caterpillar genutzt. Ein Auszug wird in folgender Abbildung dargestellt:
...
Insgesamt bietet Inkling viele Funktionalitäten, die gute Synergien mit der Umfrage von PulseShift ermöglichen können, wie beispielsweise die Funktion mit der man einsehen kann, wie viele der Mitarbeiter die Umfrage bereits gesehen haben. Außerdem könnte man für die Zukunft die Umfragen als Teilaufgaben unterteilen oder diese als solche in einer anderen Hauptaufgabe einbinden.
Jedoch liegt der Fokus bei Inkling eindeutig auf den Einzelhandel-Sektor. Daher ist die Applikation trotz einiger Synergien für die aktuelle Zielgruppe von PulseShift (Werksmitarbeiter) eher ungeeignet.
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.48]{images/Cotap_Messagingtools} 
\caption[Cotap Messagingtools]{Cotap Messagingtools\protect} 
\label{dem} 
\end{figure}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.48]{images/Cotap_3Party} 
\caption[Cotap 3RD Party Screen]{Cotap 3RD Party Screen\protect} 
\label{dem} 
\end{figure}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.48]{images/Cotap_Broadcast} 
\caption[Cotap Broadcast Screen]{Cotap Broadcast Screen\protect} 
\label{dem} 
\end{figure}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.48]{images/Cotap_Networkmap} 
\caption[Cotap Networkmap]{Cotap Networkmap\protect} 
\label{dem} 
\end{figure}
...
\begin{figure}[H] 
\centering 
\includegraphics[scale=0.48]{images/Cotap_Integration} 
\caption[Cotap Integration]{Cotap Integration\protect} 
\label{dem} 
\end{figure}
