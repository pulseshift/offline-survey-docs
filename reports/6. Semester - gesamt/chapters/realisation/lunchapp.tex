...
Die Idee der Lunchapp ist es, den Medienbruch zu den Offline-Mitarbeitern m�glichst fr�h zu nehmen und eine App zu entwickeln, die kontinuierlich von den Mitarbeitern genutzt wird. W�hrend der Nutzung wird der Mitarbeiter gefragt, ob er an einer Umfrage teilnehmen m�chte, und kann dies auch direkt aus der App tun. Der Vorteil einer Lunchapp ist hier vor allem, dass es sich um unkritische Daten handelt. Um diesen Punkt zu verdeutlichen, wird eine andere M�glichkeit weiter beleuchtet: Der Dienstplan. Hierbei handelt es sich um datenschutzrechtlich sensible Daten, die keineswegs frei verf�gbar gemacht werden d�rfen. Dementsprechend wurde f�r eine prototypische Implementierung eine Lunchapp ausgew�hlt.
